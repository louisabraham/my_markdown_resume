...
% Copyright 2017 Louis Abraham <https://github.com/louisabraham/>
...
\definecolor[sectioncolor][h=3872b2]
\definecolor[rulecolor][h=77a4d4]
...
\setupbodyfont[$if(font-size)$$font-size$$else$11pt$endif$]
